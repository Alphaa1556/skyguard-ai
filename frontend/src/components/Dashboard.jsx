    ...
    <section className="dashboard" id="stations">
      ...
      <div className="dashboard-grid">
        ...
        <div className="alert-center">
          ...
          {alerts.map(a => (
            <button key={a.station_id} className="alert-item" onClick={() => setSelectedId(a.station_id)}>
              <span className="alert-item-dot" />
              <div className="alert-item-body">
                <span className="alert-item-title">{a.name} <span className="mono">· {a.anomaly.type}</span></span>
                <span className="alert-item-sub">{a.anomaly.affected_parameter} · {Math.round(a.anomaly.confidence * 100)}% confidence</span>
              </div>
            </button>
          ))}
        </div>
